...
const ApplicantProfilePreview = ({
  ...
  const onChangeStatus = async (e) => {
    ...
    try {
      ...
      console.error(selectedApplicant.status);
  ...
  return (
    <div className='fixed inset-0 bg-[rgba(0,0,0,0.2)] bg-opacity-50 flex items-center justify-center p-4 z-30'>
      <div className='bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto mt-3 custom-scrollbar'>
        {/* Modal Header  */}
        ...
        <div className='px-6 py-4'>
          ...
          <div className='space-y-3'>
            ...
            <button
              ...
              className='w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors outline-none'
            >
