...
const JobCard = ({ job, onClick, onToggleSave, onApply, saved, hideApply }) => {
  ...
  return (
    ...
    >
      <div className='flex items-start justify-between mb-4'>
        <div className='flex items-start gap-4'>
          {job?.company?.companyLogo ? (
            ...
            <div className='w-14 h-14 bg-gray-50 rounded-2xl border-2 border-gray-200 flex items-center justify-center'>
      ...
      <div className='flex items-center justify-between text-xs font-medium  mb-5 pb-4 border-b border-gray-100'>
