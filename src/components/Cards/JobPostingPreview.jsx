              ...
              <div className='relative z-10'>
                <div className='flex items-start justify-between mb-0'>
                  <div className='flex-1'>
                    <h2 className='text-lg lg:text-xl font-semibold mb-2 leading-tight text-gray-900'>
                      {formData.jobTitle}
                    </h2>
                ...
                <div className='flex flex-wrap gap-3 mt-6 md:mt-0'>
                  ...
                  <div className='flex items-center space-x-1 px-4 py-2 bg-gray-50 text-sm text-gray-700 font-semibold rounded-full border border-purple-200'>
              ...
              <div className='relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl'>
                ...
                <div className='relative z-10'>
                  <div className='flex items-center justify-between'>
                    ...
                    <div className='hidden md:flex items-center space-x-2 text-sm text-emerald-600 bg-emerald-100 px-3 py-1 rounded-full'>
