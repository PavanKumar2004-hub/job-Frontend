      ...
      >
        ...
        <div className='flex items-center h-16 border-b border-gray-200 pl-6'>
          {!sidebarCollapsed ? (
            <Link className='flex items-center space-x-3' to='/'>
              <div className='h-8 w-8 bg-gradient-to-r from-blue-600 to-indigo-700  flex items-center justify-center rounded-lg'>
                <Briefcase className='h-5 w-5 text-white' />
              </div>
              <span className='text-gray-900 font-bold text-xl'>JobPortal</span>
            </Link>
          ) : (
            <div className='h-8 w-8 bg-gradient-to-br from-blue-600 to-blue-700  flex items-center justify-center rounded-xl'>
        ...
        <div className=' absolute bottom-4 left-4 right-4'>
          <button
            ...
            onClick={logout}
          >
            <LogOut className='h-5 w-5 flex-shrink-0 text-gray-900' />
