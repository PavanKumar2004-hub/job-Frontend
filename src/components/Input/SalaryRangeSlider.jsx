      ...
      <div className='grid grid-cols-2 gap-4'>
        <div>
          ...
          <input
            ...
            min={'0'}
            step={'1000'}
            className='outline-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50'
            value={minSalary || ''}
