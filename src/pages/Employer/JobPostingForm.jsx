...
const JobPostingForm = () => {
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.salaryMin || !formData.salaryMax) {
      ...
      errors.salary = 'Maximum salary must be grater than minimum salary';
    }
    return errors;
  };
              ...
              <div className='space-y-2'>
                ...
                <div className='grid grid-cols-3 gap-3'>
                  <div className='relative'>
                    <div className='absolute inset-0 left-0 pl-3 flex items-center pointer-events-none z-10'>
                    ...
                    <input
                      ...
                      className='w-full pl-10 pr-3 py-2.5 border rounded-lg text-base transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-opacity-20 border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                    />
                  </div>
                  <div className='relative'>
                    <div className='absolute inset-0 left-0 pl-3 flex items-center pointer-events-none z-10'>
