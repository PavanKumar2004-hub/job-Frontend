                      ...
                      <div className='space-y-4'>
                        {applications.map((application) => (
                          ...
                          >
                            ...
                            {/* Actions  */}
                            <div className=' flex items-center gap-3 mt-4 md:m-0 justify-between sm:justify-between'>
                              ...
                              <div className='flex items-center gap-3'>
                                <button
                                  ...
                                  className='inline-flex items-center gap-2 px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors outline-none'
                                >
                                ...
                                <button
                                  ...
                                  className='inline-flex items-center gap-2 px-3 py-2 bg-gray-200 text-gray-700 sm:text-sm text-xs font-medium rounded-lg hover:bg-gray-300 transition-colors outline-none'
                                >
