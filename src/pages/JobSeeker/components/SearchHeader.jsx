        ...
        <div className='flex flex-col lg:flex-row gap-3 lg:gap-4'>
          <div className='flex-1 relative'>
            ...
            <input
              ...
              className='w-full pl-12 pr-4 py-2 lg:py-2.5 border border-gray-200 rounded-lg lg:rounded-xl outline-0 text-base bg-white/50 backdrop-blur-sm'
          ...
          <button className='bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 lg:px-10 py-2 lg:py-2.5 rounded-lg lg:rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-200 font-semibold text-base shadow-lg hover:shadow-xl transform hover:-translate-y-0.5'>
            Search Jobs
          </button>
        </div>
      </div>
