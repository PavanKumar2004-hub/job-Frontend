          ...
          <div className='bg-white p-6 rounded-lg'>
              ...
              <div className='relative z-10'>
                <div className='flex items-center gap-3 mb-6'>
                  ...
                  <div className='flex-1'>
                    <h1 className='text-lg lg:text-left font-semibold mb-2 leading-tight text-gray-900'>
                      {jobDetails.title}
                    </h1>
                ...
                <div className='flex flex-wrap gap-3'>
                  <span className='px-4 py-2 bg-blue-50 text-sm text-blue-700 font-medium rounded-full border border-blue-200'>
                    {jobDetails.category}
                  </span>
                  <span className='px-4 py-2 bg-purple-50 text-sm text-purple-700 font-medium rounded-full border border-purple-200'>
                    {jobDetails.type}
                  </span>
                  <div className='flex items-center space-x-1 px-4 py-2 bg-gray-50 text-sm text-gray-700 font-medium rounded-full border border-gray-200'>
            ...
            <div className='px-0 pb-8 space-y-8'>
              ...
              <div className='relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl'>
                <div className='absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 -translate-y-16 translate-x-16 rounded-full'></div>
                <div className='relative z-10'>
              ...
              <div className='space-y-4'>
                ...
                <div className='bg-gray-50 border border-gray-100 rounded-xl p-6'>
                  <div className='text-md text-gray-700 leading-relaxed whitespace-pre-wrap'>
